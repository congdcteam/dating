...
class account extends db_connect
{
    ...
    public function signup($username, $fullname, $password, $email, $sex, $year, $month, $day, $u_age, $u_sex_orientation, $language = '')
    {
        ...
        $stmt = $this->db->prepare("INSERT INTO users (free_messages_count, language, state, login, fullname, passw, email, salt, balance, bYear, bMonth, bDay, sex, u_age, sex_orientation, regtime, accountModerateAt, accountPostModerateAt, allowMessages, ip_addr) value (:free_messages_count, :language, :state, :username, :fullname, :password, :email, :salt, :balance, :bYear, :bMonth, :bDay, :sex, :age, :sex_orientation, :createAt, :accountModerateAt, :accountPostModerateAt, :allowMessages, :ip_addr)");
